...
export default function AddProduct() {
  ...
  function handleInput(e) {
    try {
      ...
      usp.style.height = "auto";        // reset first
      usp.style.height = `${usp.scrollHeight}px`; // then grow
      ...
      >
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="flex justify-center"><textarea ref={descRef} type="" name="" id="productDesc" placeholder="Description of the Product" onInput={handleInput} value={path.description} onChange={(e) => setPath({ ...path, description: e.target.value })} className="border border-[#60a5fa] rounded-2xl bg-[#eff6ff] py-2 px-4 w-[100%] focus:outline-none max-h-[200px] no_scroll_bar overflow-y-auto" data-lenis-prevent /></div>
          </div>

          <div className="flex flex-col justify-center">
            <label htmlFor="productUSP" className="text-blue-500 text-sm ">Product USP</label>
            <div className="flex justify-center"><textarea ref={uspRef} type="" name="" id="productUSP" placeholder="USP of the Product" onInput={handleInput} value={path.usp} onChange={(e) => setPath({ ...path, usp: e.target.value })} className="border border-[#60a5fa] rounded-2xl bg-[#eff6ff] py-2 px-4 w-[100%] focus:outline-none max-h-[100px] no_scroll_bar overflow-y-auto" data-lenis-prevent /></div>
          </div>
